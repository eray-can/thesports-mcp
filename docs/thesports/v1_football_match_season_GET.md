# Schedule and Results - season query(all season)

**Endpoint**: `GET /v1/football/match/season`

**Plan / Category**: `DATABASE DATA`

**Included in Your Plan**: `No ❌`

**Description**: This interface returns the full schedule and result data of the query season<br/>Request times：120 times/min<br/><br/>Note：Get the full data of the match interface, this interface does not need to be obtained again
