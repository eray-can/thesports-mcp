...
**Endpoint**: `GET /v1/football/table/live`

**Plan / Category**: `BASIC DATA`

**Included in Your Plan**: `Yes ✅`

**Description**: Returns the real-time changes in the season standings data within the last 10 minutes (full update)<br/><br/>Suggested request frequency：1~5min/time
