# Player statistics(historical matches)

**Endpoint**: `GET /v1/football/match/player_stats/detail`

**Plan / Category**: `BASIC DATA`

**Included in Your Plan**: `Yes ✅`

**Description**: Return player statistics for completed historical matches<br/>Request limit：Matches within 30 days before today<br/><br/>Request times：120 times/min
...
- **`code`** (`integer`)
- **`results`** (`array of objects`) - Player statistics data list
