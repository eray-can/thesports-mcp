...
**Endpoint**: `GET /v1/football/coach/honor/list`

**Plan / Category**: `DATABASE DATA`

**Included in Your Plan**: `No ❌`

**Description**: Return full coach honor data，and obtain new or changed data according to the time<br/><br/>1、Full update for the first time，full data is obtained according to the parameter page (Page increases by 1, loop to get the interface, total is 0, and the loop ends)<br/>2、Subsequent incremental update，obtain change data according to the parameter time increment (recommended request frequency：1min/time)
