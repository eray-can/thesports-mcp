...
**Endpoint**: `GET /v1/football/season/table/detail`

**Plan / Category**: `DATABASE DATA`

**Included in Your Plan**: `No ❌`

**Description**: Return to season rankings data details<br/>Request times：120 times/min<br/><br/>PS：Get the changed season id through the ‘data update’ interface
