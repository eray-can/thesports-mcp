...
- **`results`** (`array of objects`) - Player list
  - **`id`** (`string`) - Player id
  - **`history`** (`array of objects`) - Player market list
    - **`market_time`** (`integer`) - Change time
    - **`market_value`** (`integer`) - Market value
    - **`market_value_currency`** (`string`) - unit
