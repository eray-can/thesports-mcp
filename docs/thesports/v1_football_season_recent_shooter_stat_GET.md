# Season top scorer(newest season)

**Endpoint**: `GET /v1/football/season/recent/shooter/stat`

**Plan / Category**: `ADVANCED DATA`

**Included in Your Plan**: `Yes ✅`

**Description**: Return to the season scorer list details data(Restriction: newest season)<br/>Request times：120 times/min<br/><br/>PS：Get the changed season id through the ‘data update’ interface
