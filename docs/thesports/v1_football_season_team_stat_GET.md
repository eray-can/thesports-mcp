# Season team statistics(all season)

**Endpoint**: `GET /v1/football/season/team/stat`

**Plan / Category**: `DATABASE DATA`

**Included in Your Plan**: `No ❌`

**Description**: Return to the season team statistics details<br/>Request times：120 times/min<br/><br/>PS：Get the changed season id through the ‘data update’ interface
